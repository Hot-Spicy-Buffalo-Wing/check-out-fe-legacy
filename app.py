...
with st.expander("Create Lookbook"):
    ...
    age_range = st.selectbox("연령대", ["10대 초반", "10대 후반", "20대 초반", "20대 후반", "30대 초반", "30대 후반", "40대 이상"])
    ...
    if st.button("lookbook 생성"): 
        ...
        response=requests.post(url, json={"gender": gender, "ageRange": age_range, "area":{"province":province_selection, "city":city_selection, "district":district_selection}, "TPO":tpo})
